...
const MAP_DATA = {
  ...
  "Ground Zero": {
    ...
    labels: [
      ...
      [115, 104, "Oasis"], [115, 30, "ASAP Winery"], [43, 150, "Tarbank"],
      [58, 234, "GAGRIN Hotel"], [97, 223, "M Showroom"], [-13, 48, "Science Office"]
    ],
  },
  Factory: {
    ...
    labels: [
      [21, 39, "Office Building"], [15.5, 39, "Main Office"], [24.5, 39, "Breach Room"],
      [30.5, 39, "Locked Office"], [35, 39, "North Stairs"], [9, 39, "South Stairs"],
      [34, 26, "Sky Bridge"], [29.5, 17, "Connector"], [29, 41, "Locker Rooms"],
      [15, 41, "Sinks"], [20, 42, "Hole"], [-3, 37, "Platform"], [-21, 27, "Servers"],
      [-18, -29, "Med Tent"], [4.5, 10.5, "Silos"], [30, -8.5, "Heli Crash"], [-1, 16, "Pit"],
      [-2, -24.5, "Underground Stash"], [-20.5, 23, "Scav Bunker"], [-18, 50, "Blue Containers"],
      [-45.5, 61, "Wood Room"], [68.25, -20, "Glass Hall"], [56, 5, "Boilers"],
      [41, -11, "Pumping Station"], [44, -36, "East Halls"], [66, -42, "Forklifts"],
      [18, 4, "Rafters"]
    ],
  },
  Customs: {
  ...
  Shoreline: {
    ...
    labels: [
      [-258.2, -71.2, "Resort"], [-215.8, 178.4, "Power Station"], [-189.3, 420, "Gas Station"],
      [-496, 257, "Weather Station"], [-708.9, 93.91, "Radio Tower"], [326, -118.5, "Swamp"],
      [418.4, 118, "Village"], [288, 144, "Cabins"], [128, 93, "Cottages"],
      [-355, 188, "Tank Bridge"], [-338.6, 525, "Pier"], [216, 424, "Scav Island"],
      [-96, -6, "Bus Stop"], [52, 134, "Construction"], [-153, -290, "Bunker"],
      [-625, 484, "Crane"], [-622, -202, "Scav Farm"], [-171, -83, "West Wing"],
      [-329, -83, "East Wing"], [-252, -146, "Admin"]
    ],
  },
  Interchange: {
    ...
    labels: [
      [-186.4, -318.7, "Power Station"], [155, -253, "Go Kart"], [158, -78.5, "Four Camp"],
      [68.2, 312.9, "Cargo Containers"], [-260.2, 123.8, "Wall Break"], [-175.5, 145.1, "Ramps"],
      [202.3, 219.4, "Oli Tower"], [46.5, -358.5, "Idea Tower"], [263.2, -11.1, "Scav Camp"],
      [373.5, -391.2, "Highway Construction"], [33, -222, "Garage A"], [47, -112, "Garage B"],
      [0, 47, "Garage C"], [20, 138, "Garage D"], [-34, -235, "IDEA"], [-115, -45, "Goshan"],
      [-28, 140, "OLI"], [87, -165, "Nortex"], [60, -152, "TRend"], [69.5, -134, "Mode7"],
      [19, -129, "TTS"], [-38, -129, "Book Store"], [91, -119, "Dino Clothes"],
      [18, -103, "EMERCOM"], [-28, -103, "Kostin"], [-65, -103, "Bizarro"], [92, -87, "Spiel"],
      [-18, -87, "Voyage"], [57, -66, "Viking"], [13, -66, "Mantis"], [-18, -72, "German"],
      [57, -32, "The National"], [13, -32, "Brutal"], [-18, -25, "Kiba"],
      [-34, -20, "Pretty Lights"], [92, -18, "Telespot"], [62, -12, "Revis"], [19, -6, "ADIK"],
      [-28, 0.5, "Generic"], [92, 15, "Top Brand"], [61, 15, "Sports"], [70, 32, "Yushka"],
      [19.5, 26, "Rasmussen"], [-37, 26, "Avokado"], [91, 55, "Boots 4 Life"], [61, 50, "Texho"],
      [6, 49, "Dom"], [38, -170, "Father & Sons"], [69, -150, "Tarkovstar"],
      [26, -149, "Eastland"], [71, -130, "Arena"], [54, -128, "ТАРЗДРАВ"],
      [20, -128, "МЕБЕЛЬ МК"], [69, -116, "Intourist"], [-27, -103, "Burger Spot"],
      [70, -94, "FCK"], [70, -87, "McDaniels"], [64, -69, "Tarducks"], [43, -69, "Coffee Joy"],
      [15, -74, "Jacob & Jacob"], [-34, -79, "ПУШКИН"], [64, -34, "Sushi Huyushi"],
      [-17, -32, "Underway"], [67, -23.5, "Burger House"], [-34, -24, "Philly Cute"],
      [67, -16, "Shiccos"], [17, 0, "МУЗЕЙ ИСТОРИИ"], [92, 17, "Papillon"],
      [58, 13, "ЗАКРЫТО НА РЕМОНТ"], [70, 27, "НА-СВЯЗИ"], [54, 24, "СКОРО ОТКРЫТИЕ"],
      [19, 26, "Figaro"], [71, 47, "АПТЕКА"], [53, 47, "SARA"], [26, 46, "Urban Clothes"],
      [91, 54, "TECHLIGHT"], [39, 67, "Fashion Store"]
    ],
  },
  Reserve: {
